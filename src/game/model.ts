...
import { ServerEvent, ServerIO } from "../types/event.types";
import { Game, GameBase, GameStatus, Player, Round } from "../types/game.types";
...
export class GameManager {
  ...
  public resetGame(): void {
    this.update((game) => {
      const lastRound: any = last(game.rounds);
      const lastTurn: any = last(lastRound?.turns);
